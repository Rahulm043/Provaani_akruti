...
| :--- | :--- | :--- |
| **GCP VM** | `34.131.238.156` | Instance: `instance-20260815-072654`, Zone: `asia-south2-b`, Project: `project-cb090c10-8c6d-44c8-bbb` (2 vCPU, 4 GB RAM) |
| **Containers** | Docker Compose Direct | `provaani_akruti-api-1` (`:8000`), `dograhtest-custom-ui` (`:80`, `:3011`), `provaani_akruti-ui-1` (`:3010`), `postgres` (`127.0.0.1:5432`), `redis` (`127.0.0.1:6379`), `minio` (`127.0.0.1:9000`) |
| **Ingress Mode** | Direct Public Static IP | Direct communication to `http://34.131.238.156:8000` — Zero Cloudflare tunnel dependencies. Plivo webhooks route directly. |
