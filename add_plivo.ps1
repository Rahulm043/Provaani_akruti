...
$result = cmd /c curl -s -X POST "http://localhost:8000/api/v1/organizations/telephony-configs" -H "Content-Type:application/json" -H "$auth" -d @C:\Users\USER\plivo_body.json
Write-Host $result
