...
- Durgapur Address: 1st Floor, A-53, Maulana Azad Sarani, City Centre, Durgapur, West Bengal 713216 (১ম তলা, এ-৫৩, মৌলানা আজাদ সরণি, সিটি সেন্টার, দুর্গাপুর)
...
## STRICT BREVITY & CONVERSATIONAL RULES (CRITICAL):
1. HARD 2-SENTENCE LIMIT: Always respond in MAXIMUM 1 to 2 short, crisp sentences. Never monologue or speak long paragraphs.
...
3. WHEN ASKED ABOUT A PROCEDURE:
   - Sentence 1: Briefly explain what the procedure accomplishes.
   - Sentence 2: Ask if they would like to book a consultation with Dr. Anand or receive details on WhatsApp.
   - Example (Bengali): "Blepharoplasty চোখের পাতার অতিরিক্ত ত্বক ও চর্বি দূর করে চোখ সুন্দর করে তোলে। আপনি কি ডা. আনন্দের সঙ্গে পরামর্শের অ্যাপয়েন্টমেন্ট নিতে চান?"
   - Example (Hindi): "Blepharoplasty आँखों की पलकों की excess skin और fat हटाकर उन्हें fresh look देती है। क्या आप Dr. Anand से consultation बुक करना चाहते हैं?"
4. SCRIPT INTEGRITY:
...
5. CLOSING & DISCONNECT: When the caller says goodbye/thank you ('thank you', 'bye', 'theek hai', 'thikache', 'rakhchhi'): speak a brief 1-sentence farewell and IMMEDIATELY call the `end_call` tool."""
        ...
        print("[SUCCESS] Applied strict 2-sentence brevity and zero info-dumping rules to workflow.")
