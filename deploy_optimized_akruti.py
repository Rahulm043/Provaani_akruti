...
async def main():
    async with db_client.async_session() as session:
        ...
        # 1. Update workflow configurations (LLM temp=0.1, TTS speed=0.9)
        workflow_configurations = {
            ...
            "dictionary": "Akruti, Aesthetics, Dr. Kaushal Priya Anand, Durgapur, Burdwan, Facelift, Blepharoplasty, Dimpleplasty, Buccal Fat, Rhinoplasty, Lip Augmentation, Chin Augmentation, Ear Reconstruction, Gynaecomastia, Liposuction, Abdominoplasty, Tummy Tuck, 6-Pack Abs, Micro Needling, Mole Excision, Botox, Fillers, Cryolipolysis, PRP, Eyebrow Transplant, Beard Transplant, Micropigmentation, Maxillofacial, Replantation, WhatsApp",
            "max_call_duration": 600,
            "max_user_idle_timeout": 30,
            "user_turn_stop_timeout": 0.8
        }

        # 2. Compact, anti-hallucination unified prompt
...
5. CLOSING & DISCONNECT: When the caller concludes ('thank you', 'bye', 'theek hai', 'thikache', 'rakhchhi', 'dhanyawad'): speak a warm 1-sentence farewell in their active language and IMMEDIATELY call the `end_call` tool."""
        ...
        print("[SUCCESS] Fully optimized Akruti Aesthetics workflow deployed (Temp=0.1, TTS Speed=0.9, Natural Pauses, All Website Procedures, Strict Anti-Hallucination).")
